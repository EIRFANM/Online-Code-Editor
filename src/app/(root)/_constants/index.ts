...
// Define the THEMES array (no change needed here)
...
// Define the THEMES_DEFINITIONS object with explicitly typed `base`
export const THEME_DEFINITIONS = {
  "github-dark": {
    base: "vs-dark" as monaco.editor.BuiltinTheme, // Explicitly cast to BuiltinTheme
    inherit: true,
    rules: [
...
export const defineMonacoThemes = (monaco: typeof import("monaco-editor")) => {
  Object.entries(THEME_DEFINITIONS).forEach(([themeName, themeData]) => {
    monaco.editor.defineTheme(themeName, {
      base: themeData.base, // base is now correctly typed as BuiltinTheme
